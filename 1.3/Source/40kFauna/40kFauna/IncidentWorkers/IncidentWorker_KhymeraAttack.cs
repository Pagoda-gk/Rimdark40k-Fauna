...
namespace AdeptusMechanicus
{
    public class IncidentWorker_KhymeraAttack : IncidentWorker
    {
        public override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            IntVec3 intVec;
            return map.mapTemperature.SeasonAndOutdoorTemperatureAcceptableFor(FaunaRacesDefOf.OG_Xenos_Khymera) && this.TryFindEntryCell(map, out intVec);
        }
        ...
        public override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            for (i = 0; i < toSpawn; i++)
            {
                ...
                Pawn newThing = PawnGenerator.GeneratePawn(FaunaPawnKindDefOf.OG_Xenos_Khymera, null);
